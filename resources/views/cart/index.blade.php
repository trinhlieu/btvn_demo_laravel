                ...
                <div class="col-12">
                    ...
                    <table class="table shopping-summery">
                        ...
                        @if($oldCart)
                            ...
                            <tr>
                                <td class="image" data-title="No"><img src="{{ asset('storage/' . $item->image) }}"
                                                                       alt="#"></td>
                                <td class="product-des" data-title="Description">
                                    <p class="product-name"><a href="#">{{ $item->name }}</a></p>
                                    <p class="product-des">{{ $item->desc }}</p>
                                </td>
                                ...
                                <td class="action" data-title="Remove"><a href="{{ route('cart.remove', $key) }}"><i class="ti-trash remove-icon"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        @else
